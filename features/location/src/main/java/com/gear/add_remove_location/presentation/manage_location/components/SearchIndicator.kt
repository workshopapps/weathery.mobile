...
fun SearchIndicator(
    ...
    color: Color = Primary500, // color of indicator arc line
    strokeWidth: Dp = ProgressIndicatorDefaults.StrokeWidth //width of circle and ar lines
) {
    ...
    Canvas(
        ...
        drawCircle(Color.Gray, style = stroke)
